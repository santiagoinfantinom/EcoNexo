...
### URLs de Producción
- `https://econexo-web.vercel.app/auth/callback`
...
5. Configura las URLs de redirección autorizadas:
   ...
   - `https://econexo-web.vercel.app/auth/callback` (producción)
...
3. Configura las URLs:
   - **Homepage URL**: `https://econexo-web.vercel.app`
   - **Authorization callback URL**: `https://econexo-web.vercel.app/auth/callback`
