...
Esto explica por qué `econexo-web.vercel.app` muestra una página diferente.
...
6. **Configurar dominios:**
   ...
   - Agrega `econexo-web.vercel.app` si no está
...
5. **Configurar dominios:**
   - Agrega `econexo-web.vercel.app` y `econexo.ai`
...
2. **Verifica los dominios:**
   - https://econexo-web.vercel.app debería mostrar la página correcta
...
Si `econexo-web.vercel.app` o `econexo.ai` ya están asignados al proyecto incorrecto:
