...
3. **Configurar la aplicación:**
   ...
   - **Authorized JavaScript origins:**
     ...
     - `https://econexo-web.vercel.app` (producción)
...
3. **Configurar autenticación:**
   - Ve a "Authentication"
   - Agrega redirect URI: `https://econexo-web.vercel.app/auth/outlook/callback`
...
NEXT_PUBLIC_EMAIL_FROM=noreply@econexo-web.vercel.app
