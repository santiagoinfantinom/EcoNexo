...
2. Haz clic en **"Add"** o **"Add Variable"** para cada una:
   ...
   **Variable 1:**
   ...
   - **Value**: `https://econexo-web.vercel.app`
   - **Environment**: Selecciona todas (Production, Preview, Development)

   **Variable 2:**
   - **Name**: `NEXT_PUBLIC_PLAUSIBLE_DOMAIN`
   - **Value**: `econexo-web.vercel.app`
...
2. Abre en tu navegador:
   - **https://econexo-web.vercel.app** - Debería mostrar el proyecto colorido
...
- [ ] Deploy exitoso
- [ ] Dominio `econexo-web.vercel.app` configurado y funcionando
