...
const DICTS: Record<Locale, Dict> = {
  en: {
    ...
    sustainableMonetization: "Sustainable Monetization",
    sustainableMonetizationDescription: "Support verified projects, discover sustainable offers and access premium features that drive environmental impact.",
  ...
  de: {
    ...
    // Sustainable Monetization
    sustainableMonetization: "Nachhaltige Monetarisierung",
    sustainableMonetizationDescription: "Unterstützen Sie verifizierte Projekte, entdecken Sie nachhaltige Angebote und greifen Sie auf Premium-Funktionen zu, die den Umweltimpact fördern.",
    ...
    month: "Monat",
    year: "Jahr",
    ofRevenueDonated: "der Einnahmen werden an Umweltprojekte gespendet",
  ...
  es: {
    ...
    // Sustainable Monetization
    sustainableMonetization: "Monetización Sostenible",
    sustainableMonetizationDescription: "Apoya proyectos verificados, descubre ofertas sostenibles y accede a funciones premium que impulsan el impacto ambiental.",
    ...
    month: "mes",
    year: "año",
    ofRevenueDonated: "de los ingresos se donan a causas ambientales",
