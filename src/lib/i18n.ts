...
const DICTS: Record<Locale, Dict> = {
  ...
  fr: {
    ...
    volunteersPageTitle: "Devenir bénévole",
    localRecords: "Enregistrements locaux",
    noVolunteersYet: "Aucun bénévole enregistré pour le moment.",
    name: "Nom",
    email: "Email",
    ...
    also: "aussi",
    reached: "atteint",
    titlePh: "Nom de l'événement",
    cityPh: "Ville",
    countryPh: "Pays",
    capacityPh: "Nombre de places",
    notesPh: "Détails, exigences, etc.",
    availabilityPh: "Ex: week-ends",
    ...
    reset: "Réinitialiser",
    sustainableProjectsSince2024: "PROJETS DURABLES DEPUIS 2024",
    connectingEurope: "Connecter l'Europe.",
    transformingFuture: "Transformer l'avenir.",
    discoverEnvironmentalProjects: "Découvrez des projets environnementaux, des événements communautaires et des opportunités de bénévolat qui construisent un avenir plus durable à travers l'Europe.",
    activeProjects: "Projets actifs",
    connectedVolunteers: "Bénévoles connectés",
    exploreProjects: "EXPLORER LES PROJETS",
    filterByCategoryAndFind: "Filtrez par catégorie et trouvez votre prochaine opportunité d'impact.",
    sustainableProjectsMap: "Carte des Projets Durables",
    ...
    centerOnLocation: "Centrer sur ma localisation",
    // Calendar
    calendar: "Calendrier",
    month: "Mois",
    week: "Semaine",
    ...
    clusterInfo: "projets dans cette zone",
    clusterMarkers: "Grouper les marqueurs",
    cluster: "Grouper",
    individual: "Individuel",
    // Eco Tips
    ecoTips: "Conseils Écologiques",
    ecoTipsDescription: "Découvrez des moyens simples de réduire votre impact environnemental",
    ...
    hard: "Difficile",
    jobs: "Emplois verts",
    searchJobsPlaceholder: "Rechercher par titre, entreprise ou domaine",
    minSalary: "Salaire minimum (€)",
    minExperience: "Années d'expérience (min)",
    results: "résultats",
    cityLabel: "Ville",
    ...
    cvLink: "Lien vers votre CV (optionnel)",
    sendApplication: "Envoyer la candidature",
    applicationSent: "Candidature envoyée !",
    unsaved: "Retiré des sauvegardés",
    // Job posting conditions
    jobPostingConditions: "Conditions de publication d'emploi",
    jobPostingInfo: "Pour maintenir la qualité de nos offres d'emploi vertes, tous les employeurs doivent respecter nos standards de durabilité et de responsabilité sociale.",
    conductGuidelines: "Directives de conduite",
    conductGuidelinesText: "• Engagement démontrable envers les pratiques environnementales durables\n• Salaires équitables et conditions de travail équitables\n• Politiques de diversité et d'inclusion\n• Transparence dans les informations de l'entreprise\n• Conformité aux réglementations du travail locales",
    createJobOffer: "Créer une offre d'emploi",
    // Job Creation Form
    jobTitle: "Titre du Poste",
    jobTitlePlaceholder: "Ex: Spécialiste en Énergie Solaire",
    companyName: "Nom de l'Entreprise",
    companyNamePlaceholder: "Ex: GreenTech Solutions",
    jobDescription: "Description du Poste",
    jobDescriptionPlaceholder: "Décrivez les responsabilités et exigences du poste...",
    jobLocation: "Localisation",
    jobLocationPlaceholder: "Ex: Paris, France",
    ...
    jobTypeRemote: "Télétravail",
    jobTypeHybrid: "Hybride",
    salaryRange: "Fourchette de Salaire",
    salaryRangePlaceholder: "Ex: €30,000 - €45,000",
    ...
    requiredSkillsPlaceholder: "Ex: React, Node.js, Python...",
    benefits: "Avantages",
    benefitsPlaceholder: "Ex: Assurance santé, télétravail, développement professionnel...",
    applicationDeadline: "Date Limite de Candidature",
    contactEmail: "Email de Contact",
    contactEmailPlaceholder: "rh@entreprise.com",
    publishJob: "Publier l'Emploi",
    saveDraft: "Enregistrer le Brouillon",
    jobCreated: "Emploi créé avec succès",
    jobError: "Erreur lors de la création de l'emploi",
    employerGuidelines: "Directives pour les employeurs",
    noParticipatedEvents: "Vous n'avez participé à aucun événement pour le moment",
    supportUs: "Nous Soutenir",
    // Job Application Form
    motivations: "Motivations",
    motivationsPlaceholder: "Expliquez pourquoi vous êtes intéressé par cet emploi et comment vous contribueriez à la mission de l'entreprise...",
    expertiseAreas: "Domaines d'Expertise",
    expertiseAreasPlaceholder: "Décrivez vos domaines de spécialisation, compétences techniques et expérience pertinente...",
    motivationLetter: "Lettre de Motivation",
    clickToUpload: "Cliquer pour télécharger le fichier",
    ...
    chatRulesTitle: "Nos Valeurs Communautaires",
    chatRulesIntro: "Cet espace est conçu pour favoriser des connexions positives et constructives entre les membres de notre communauté écologique.",
    chatRule1: "💚 Amour et Compassion: Traitez tout le monde avec amour, respect et compréhension.",
    chatRule2: "🤝 Empathie: Mettez-vous à la place des autres avant de répondre.",
    chatRule3: "🌱 Construction Positive: Partagez des idées qui contribuent au bien-être commun.",
    chatRule4: "🌍 Respect Environnemental: Gardez toutes les conversations alignées avec nos valeurs écologiques.",
    chatRule5: "✨ Inspiration: Motivez et inspirez les autres sur leur chemin vers la durabilité.",
    chatRule6: "🛡️ Espace Sûr: Nous ne tolérons pas la discrimination, le harcèlement ou le contenu négatif.",
    chatRule7: "🎯 Objectif: Gardez les conversations axées sur des sujets liés à la durabilité et à la communauté.",
    chatRule8: "💬 Communication Constructive: Exprimez vos idées clairement et respectueusement.",
    chatRulesFooter: "En participant à ce chat, vous acceptez de suivre ces valeurs. Ensemble, nous construisons une communauté plus durable et aimante !",
    sendMessage: "Envoyer un message",
    typeMessage: "Tapez votre message...",
    onlineUsers: "Utilisateurs en ligne",
    joinConversation: "Rejoindre la conversation",
    welcomeMessage: "Bienvenue dans le chat communautaire EcoNexo ! 🌿",
    topicForums: "Forums Thématiques",
    recommendations: "Recommandations",
    popularDiscussions: "Discussions Populaires",
    joinActiveConversations: "Rejoignez les conversations les plus actives",
    newProjects: "Nouveaux Projets",
    discoverLatestInitiatives: "Découvrez les dernières initiatives durables",
    eventsNearYou: "Événements Près de Vous",
    findLocalEvents: "Trouvez des événements locaux et des rencontres",
    ...
    passions: "Passions",
    passionsPlaceholder: "Ex: Durabilité, Énergie Renouvelable, Conservation...",
    areasOfExpertise: "Domaines d'Expertise",
    expertisePlaceholder: "Ex: Ingénierie Environnementale, Éducation, Agriculture Biologique...",
    hobbies: "Loisirs",
    hobbiesPlaceholder: "Ex: Jardinage, Randonnée, Photographie de Nature...",
    interests: "Intérêts",
    interestsPlaceholder: "Ex: Changement Climatique, Biodiversité, Technologie Verte...",
    skills: "Compétences",
    skillsPlaceholder: "Ex: Leadership, Communication, Analyse de Données...",
    languages: "Langues",
    languagesPlaceholder: "Ex: Français, Anglais, Allemand...",
    ...
    volunteerProgress: "Progrès des bénévoles",
    ...
    motivationToParticipate: "Pourquoi voulez-vous participer à cet événement ?",
    dietaryRestrictions: "Restrictions alimentaires (optionnel)",
    accessibilityNeeds: "Besoins d'accessibilité (optionnel)",
    consents: "Consentements",
    photoVideoConsent: "J'autorise l'utilisation de mon image dans les photos/vidéos de l'événement à des fins promotionnelles",
    ...
    emergencyContactPhoneRequired: "Le téléphone d'urgence est requis",
    motivationRequired: "Veuillez expliquer pourquoi vous voulez participer",
...
const CATEGORY_MAP: Record<string, { en: string; de: string; fr: string }> = {
  "Medio ambiente": { en: "Environment", de: "Umwelt", fr: "Environnement" },
  "Educación": { en: "Education", de: "Bildung", fr: "Éducation" },
  "Salud": { en: "Health", de: "Gesundheit", fr: "Santé" },
  "Comunidad": { en: "Community", de: "Gemeinschaft", fr: "Communauté" },
  "Océanos": { en: "Oceans", de: "Ozeane", fr: "Océans" },
  "Alimentación": { en: "Food", de: "Ernährung", fr: "Alimentation" },
};
...
const IMPACT_TAG_MAP: Record<string, { en: string; de: string; fr: string }> = {
  "Reforestación": { en: "Reforestation", de: "Aufforstung", fr: "Reforestation" },
  "Calidad del aire": { en: "Air quality", de: "Luftqualität", fr: "Qualité de l'air" },
  STEM: { en: "STEM", de: "STEM", fr: "STEM" },
  "Inclusión": { en: "Inclusion", de: "Inklusion", fr: "Inclusion" },
  "Prevención": { en: "Prevention", de: "Prävention", fr: "Prévention" },
  "Acceso": { en: "Access", de: "Zugang", fr: "Accès" },
  "Integración": { en: "Integration", de: "Integration", fr: "Intégration" },
  "Cultura": { en: "Culture", de: "Kultur", fr: "Culture" },
  "Playas limpias": { en: "Clean beaches", de: "Saubere Strände", fr: "Plages propres" },
  "Biodiversidad": { en: "Biodiversity", de: "Biodiversität", fr: "Biodiversité" },
  "Huertos urbanos": { en: "Urban gardens", de: "Urbane Gärten", fr: "Jardins urbains" },
  "Comunidad": { en: "Community", de: "Gemeinschaft", fr: "Communauté" },
};
...
const PROJECT_DESCRIPTION_MAP: Record<string, { en: string; de: string; fr: string }> = {
  p1: {
    ...
    fr: "Plantation d'arbres indigènes dans les quartiers manquant d'espaces verts, impliquant les écoles et les organisations locales.",
  },
  p2: {
    ...
    fr: "Programme STEAM pour les jeunes à risque, axé sur le prototypage et la pensée computationnelle.",
  },
  p3: {
    ...
    fr: "Soins primaires mobiles axés sur la prévention et les contrôles de base dans les quartiers périphériques.",
  },
  p4: {
    ...
    fr: "Nettoyage côtier, surveillance du microplastique et éducation environnementale pour touristes et résidents.",
  },
  p5: {
    ...
    fr: "Réseau de jardins communautaires pour renforcer la sécurité alimentaire et promouvoir une alimentation durable.",
  },
  p6: {
    ...
    fr: "Création de centres communautaires avec programmation culturelle et ateliers d'intégration pour les nouveaux résidents.",
  },
};
...
const PROJECT_NAME_MAP: Record<string, { en: string; de: string; fr: string }> = {
  p1: { en: "Berlin Urban Reforestation", de: "Urbane Aufforstung Berlin", fr: "Reforestation Urbaine Berlin" },
  p2: { en: "Educational Robotics Workshop", de: "Workshop für Bildungsrobotik", fr: "Atelier de Robotique Éducative" },
  p3: { en: "Community Mobile Clinic", de: "Mobile Gemeinschaftsklinik", fr: "Clinique Mobile Communautaire" },
  p4: { en: "Beach Recovery", de: "Strandaufbereitung", fr: "Récupération de Plage" },
  p5: { en: "Urban Gardens", de: "Urbane Gärten", fr: "Jardins Urbains" },
  p6: { en: "Inclusive Neighborhood Centers", de: "Inklusive Nachbarschaftszentren", fr: "Centres de Quartier Inclusifs" },
};
...
const LOCATION_MAP: Record<string, { en: string; de: string; fr: string }> = {
  // Cities
  "Berlín": { en: "Berlin", de: "Berlin", fr: "Berlin" },
  "Madrid": { en: "Madrid", de: "Madrid", fr: "Madrid" },
  "Barcelona": { en: "Barcelona", de: "Barcelona", fr: "Barcelone" },
  "Milán": { en: "Milan", de: "Mailand", fr: "Milan" },
  "Marsella": { en: "Marseille", de: "Marseille", fr: "Marseille" },
  "París": { en: "Paris", de: "Paris", fr: "Paris" },
  "Londres": { en: "London", de: "London", fr: "Londres" },
  "Roma": { en: "Rome", de: "Rom", fr: "Rome" },
  "Ámsterdam": { en: "Amsterdam", de: "Amsterdam", fr: "Amsterdam" },
  "Viena": { en: "Vienna", de: "Wien", fr: "Vienne" },
  "Praga": { en: "Prague", de: "Prag", fr: "Prague" },
  "Varsovia": { en: "Warsaw", de: "Warschau", fr: "Varsovie" },
  "Budapest": { en: "Budapest", de: "Budapest", fr: "Budapest" },
  "Lisboa": { en: "Lisbon", de: "Lissabon", fr: "Lisbonne" },
  "Dublín": { en: "Dublin", de: "Dublin", fr: "Dublin" },
  "Estocolmo": { en: "Stockholm", de: "Stockholm", fr: "Stockholm" },
  "Oslo": { en: "Oslo", de: "Oslo", fr: "Oslo" },
  "Copenhague": { en: "Copenhagen", de: "Kopenhagen", fr: "Copenhague" },
  "Helsinki": { en: "Helsinki", de: "Helsinki", fr: "Helsinki" },
  "Atenas": { en: "Athens", de: "Athen", fr: "Athènes" },
  "Zúrich": { en: "Zurich", de: "Zürich", fr: "Zurich" },
  
  // Countries
  "Alemania": { en: "Germany", de: "Deutschland", fr: "Allemagne" },
  "España": { en: "Spain", de: "Spanien", fr: "Espagne" },
  "Italia": { en: "Italy", de: "Italien", fr: "Italie" },
  "Francia": { en: "France", de: "Frankreich", fr: "France" },
  "Reino Unido": { en: "United Kingdom", de: "Vereinigtes Königreich", fr: "Royaume-Uni" },
  "Países Bajos": { en: "Netherlands", de: "Niederlande", fr: "Pays-Bas" },
  "Austria": { en: "Austria", de: "Österreich", fr: "Autriche" },
  "República Checa": { en: "Czech Republic", de: "Tschechische Republik", fr: "République Tchèque" },
  "Polonia": { en: "Poland", de: "Polen", fr: "Pologne" },
  "Hungría": { en: "Hungary", de: "Ungarn", fr: "Hongrie" },
  "Portugal": { en: "Portugal", de: "Portugal", fr: "Portugal" },
  "Irlanda": { en: "Ireland", de: "Irland", fr: "Irlande" },
  "Suecia": { en: "Sweden", de: "Schweden", fr: "Suède" },
  "Noruega": { en: "Norway", de: "Norwegen", fr: "Norvège" },
  "Dinamarca": { en: "Denmark", de: "Dänemark", fr: "Danemark" },
  "Finlandia": { en: "Finland", de: "Finnland", fr: "Finlande" },
  "Grecia": { en: "Greece", de: "Griechenland", fr: "Grèce" },
  "Suiza": { en: "Switzerland", de: "Schweiz", fr: "Suisse" },
  "Bélgica": { en: "Belgium", de: "Belgien", fr: "Belgique" },
  "Luxemburgo": { en: "Luxembourg", de: "Luxemburg", fr: "Luxembourg" },
};
