...
const EVENT_DETAILS: Record<string, EventDetails> = {
  ...
  "e11": {
    ...
    description_en: "Learn to use air quality sensors and participate in citizen monitoring of atmospheric pollution.",
    description_de: "Lerne, Luftqualitätssensoren zu verwenden und nimm an der Bürgerüberwachung der Luftverschmutzung teil.",
    image_url: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&h=600&fit=crop",
  ...
  "e29": {
    ...
    title_en: "Climate Change Seminar",
    title_de: "Klimawandel-Seminar",
    description: "Asiste a este seminario especializado sobre los últimos avances en la lucha contra el cambio climático.",
    description_en: "Attend this specialized seminar on the latest advances in the fight against climate change.",
    description_de: "Nimm an diesem spezialisierten Seminar über die neuesten Fortschritte im Kampf gegen den Klimawandel teil.",
    image_url: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=800&h=600&fit=crop",
  ...
  "e32": {
    ...
    title_en: "Hydroelectric Energy Workshop",
    title_de: "Wasserkraft-Workshop",
    description: "Aprende sobre energía hidroeléctrica y participa en la construcción de pequeños generadores hidráulicos.",
    description_en: "Learn about hydroelectric energy and participate in the construction of small hydraulic generators.",
    description_de: "Lerne über Wasserkraft und nimm an der Konstruktion kleiner Wassergeneratoren teil.",
    image_url: "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&h=600&fit=crop",
  ...
  "e34": {
    id: "e34",
    title: "Hackathon Verde",
    title_en: "Green Hackathon",
    title_de: "Grünes Hackathon",
    description: "Únete a nuestro hackathon de 48 horas para desarrollar soluciones tecnológicas sostenibles. Incluye talleres de IoT, blockchain para transparencia ambiental y desarrollo de apps de consumo responsable.",
    description_en: "Join our 48-hour hackathon to develop sustainable technological solutions. Includes IoT workshops, blockchain for environmental transparency and development of responsible consumption apps.",
    description_de: "Nimm an unserem 48-Stunden-Hackathon teil, um nachhaltige technologische Lösungen zu entwickeln. Beinhaltet IoT-Workshops, Blockchain für Umwelttransparenz und Entwicklung von Apps für verantwortungsvollen Konsum.",
    ...
    maxVolunteers: 100,
    currentVolunteers: 65,
    requirements: ["Laptop", "Conocimientos básicos de programación", "Ideas innovadoras"],
    requirements_en: ["Laptop", "Basic programming knowledge", "Innovative ideas"],
    requirements_de: ["Laptop", "Grundkenntnisse in Programmierung", "Innovative Ideen"],
    benefits: ["Premios en efectivo", "Mentoría técnica", "Oportunidades de networking"],
    benefits_en: ["Cash prizes", "Technical mentorship", "Networking opportunities"],
    benefits_de: ["Geldpreise", "Technische Mentoring", "Netzwerkmöglichkeiten"],
  ...
  "e35": {
    ...
    description: "Aprende a construir sensores IoT para monitorear calidad del aire, humedad del suelo y temperatura. Incluye programación con Arduino y conexión a plataformas en la nube.",
    description_en: "Learn to build IoT sensors to monitor air quality, soil moisture and temperature. Includes Arduino programming and cloud platform connection.",
    description_de: "Lerne, IoT-Sensoren zu bauen, um Luftqualität, Bodenfeuchtigkeit und Temperatur zu überwachen. Beinhaltet Arduino-Programmierung und Cloud-Plattform-Verbindung.",
    image_url: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&h=600&fit=crop",
    ...
    maxVolunteers: 25,
    currentVolunteers: 18,
    requirements: ["Laptop", "Kit Arduino básico (opcional)", "Conocimientos básicos de electrónica"],
    requirements_en: ["Laptop", "Basic Arduino kit (optional)", "Basic electronics knowledge"],
    requirements_de: ["Laptop", "Grund-Arduino-Kit (optional)", "Grundkenntnisse in Elektronik"],
    benefits: ["Sensor IoT personal", "Certificado", "Acceso a plataforma cloud"],
    benefits_en: ["Personal IoT sensor", "Certificate", "Cloud platform access"],
    benefits_de: ["Persönlicher IoT-Sensor", "Zertifikat", "Cloud-Plattform-Zugang"],
  ...
  "e36": {
    ...
    description: "Workshop intensivo sobre desarrollo de aplicaciones móviles que promuevan la sostenibilidad. React Native, diseño UX ecológico y integración con APIs ambientales.",
    description_en: "Intensive workshop on mobile app development that promotes sustainability. React Native, eco-friendly UX design and integration with environmental APIs.",
    description_de: "Intensiver Workshop zur Entwicklung mobiler Apps, die Nachhaltigkeit fördern. React Native, umweltfreundliches UX-Design und Integration mit Umwelt-APIs.",
    image_url: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&h=600&fit=crop",
    ...
    maxVolunteers: 30,
    currentVolunteers: 22,
    requirements: ["Laptop", "Node.js instalado", "Conocimientos básicos de JavaScript"],
    requirements_en: ["Laptop", "Node.js installed", "Basic JavaScript knowledge"],
    requirements_de: ["Laptop", "Node.js installiert", "Grundkenntnisse in JavaScript"],
    benefits: ["App funcional", "Código fuente", "Guía de publicación"],
    benefits_en: ["Functional app", "Source code", "Publishing guide"],
    benefits_de: ["Funktionale App", "Quellcode", "Veröffentlichungsleitfaden"],
