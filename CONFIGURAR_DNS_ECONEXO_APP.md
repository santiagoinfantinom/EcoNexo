# 🌐 Configuración DNS para econexo-web.vercel.app

Esta guía te ayudará a configurar el DNS de `econexo-web.vercel.app` para que funcione con Vercel.
...
3. **Agregar el dominio:**
   ...
   - Escribe: `econexo-web.vercel.app`
...
Necesitas saber dónde compraste el dominio `econexo-web.vercel.app`. Los proveedores más comunes son:
- **Namecheap**
- **GoDaddy**
- **Google Domains**
- **Cloudflare**
...
2. **Agrega un registro A:**
   - **Tipo:** `A`
   - **Nombre/Host:** `@` o `econexo-web.vercel.app` (depende del proveedor)
...
2. **Agrega un registro CNAME:**
   - **Tipo:** `CNAME`
   - **Nombre/Host:** `@` o `econexo-web.vercel.app`
...
1. Ve a **Domain List** → Haz clic en **"Manage"** junto a `econexo-web.vercel.app`
...
1. Ve a **My Products** → Haz clic en **"DNS"** junto a `econexo-web.vercel.app`
...
1. Ve a tu dominio `econexo-web.vercel.app` en Cloudflare
2. Ve a la pestaña **"DNS"**
3. Haz clic en **"Add record"**
4. Agrega:
   - **Type:** `A`
   - **Name:** `@` o `econexo-web.vercel.app`
...
1. Ve a **My domains** → Haz clic en `econexo-web.vercel.app`
...
3. **Verificar manualmente:**
   ...
   nslookup econexo-web.vercel.app
   # O
   dig econexo-web.vercel.app
   ```
...
3. **Abre en tu navegador:**
   - Ve a: `https://econexo-web.vercel.app`
...
2. Verifica que tengas:
   ```
   NEXT_PUBLIC_SITE_URL=https://econexo-web.vercel.app
   NEXT_PUBLIC_PLAUSIBLE_DOMAIN=econexo-web.vercel.app
   ```
...
1. **Verifica que el dominio esté asignado al proyecto correcto:**
   - Ve a **Settings → Domains** en Vercel
   - Verifica que `econexo-web.vercel.app` esté asignado a tu proyecto "EcoNexo"
