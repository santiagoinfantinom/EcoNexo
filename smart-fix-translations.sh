...
find_missing_keys() {
    ...
    if [ $missing_count -gt 0 ]; then
        echo ""
        echo "📋 Primeras 20 claves faltantes:"
...
cleanup() {
    rm -f /tmp/used_keys.txt /tmp/existing_keys.txt /tmp/missing_keys.txt
}
